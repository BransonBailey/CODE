...
//   printf("%d", comp_choice);         THIS WAS FOR TESTING THE RANDOM NUMBER
   ...
   if ((input == 0 && comp_choice == 0) || (input == 1 && comp_choice == 1) || (input == 2 && comp_choice ==2)) {
       printf("Tie");
   } else if ((input == 0 && comp_choice == 1) || (input == 1 && comp_choice == 2) || (input == 2 && comp_choice == 0)) {
       printf("You Lost :(");
   } else if ((input == 0 && comp_choice == 2) || (input == 1 && comp_choice == 0) || (input == 2 && comp_choice == 1)) {
       printf("You won :)");
   }
